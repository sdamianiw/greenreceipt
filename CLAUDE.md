...
Behavioral guidelines live in the global skills (`karpathy-guidelines`, `plan-preflight`) and `~/.claude/CLAUDE.md`. They are not repeated here. Below is only what is specific to this project.
